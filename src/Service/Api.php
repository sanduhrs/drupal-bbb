...
class Api {
   ...
   */
  function createMeeting(CreateMeetingParameters $params) {
   ...
   *    into the conference.
   */
  function joinMeeting(JoinMeetingParameters $params) {
   ...
   */
  function isMeetingRunning(IsMeetingRunningParameters $params) {
   ...
   *     successfully ended.
   */
  function endMeeting(EndMeetingParameters $params) {
  ...
  function getMeetingInfo(GetMeetingInfoParameters $params) {
